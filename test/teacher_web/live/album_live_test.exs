defmodule TeacherWeb.AlbumLiveTest do
  ...
  @create_attrs %{artist: "some artist", genre: "some genre", summary: "some summary", title: "some title", year: 42}
  @update_attrs %{artist: "some updated artist", genre: "some updated genre", summary: "some updated summary", title: "some updated title", year: 43}
  @invalid_attrs %{artist: nil, genre: nil, summary: nil, title: nil, year: nil}
